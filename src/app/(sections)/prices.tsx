...
export default function Prices() {
  return (
    <SectionContainer title="PREÇOS" subtitle="Venda somente no Local">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex gap-2 max-w-80">
              ...
              <p className=" text-sm font-semibold">
                Estudantes com carteirinha, idosos e crianças até 10 anos pagam
                meia.
              </p>
            </div>
            <div className="flex gap-2 max-w-80">
              ...
              <p className="flex gap-2 text-sm font-semibold">
                O funcionamento da bilheteria inicia às 17h30. O cinema funciona
                até 00h00 horas.
              </p>
            </div>
          </div>
